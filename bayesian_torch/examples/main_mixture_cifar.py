...
import bayesian_torch.models.mixture.resnet as resnet
import numpy as np
                ...
                if is_best:
                    save_checkpoint(
                        ...
                        filename=os.path.join(
                            args.save_dir,
                            'mixture_{}_cifar.pth'.format(args.arch)))
...
def evaluate(model, val_loader):
    ...
    with torch.no_grad():
        ...
        np.save('./probs_cifar_mc.npy', pred_probs_mc)
        np.save('./cifar_test_labels_mc.npy', target_labels)
