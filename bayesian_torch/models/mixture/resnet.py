...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='A'):
        ...
        self.conv1 = Conv2dMixture(in_channels=in_planes,
                                   out_channels=planes,
                                   kernel_size=3,
                                   stride=stride,
                                   padding=1,
        ...
        self.conv2 = Conv2dMixture(in_channels=planes,
                                   out_channels=planes,
                                   kernel_size=3,
                                   stride=1,
                                   padding=1,
        ...
        if stride != 1 or in_planes != planes:
            if option == 'A':
                ...
                self.shortcut = nn.Sequential(
                    Conv2dMixture(in_channels=in_planes,
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = Conv2dMixture(in_channels=3,
                                   out_channels=16,
                                   kernel_size=3,
                                   stride=1,
                                   padding=1,
    ...
    def forward(self, x):
        ...
        '''
        for l in self.layer3:
            if "Reparameterization" in type(l).__name__:
